            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="text-center mb-5">
                        ...
                        <p class="content text-muted">
                            Ann holds a Bachelor of Arts in Elementary Education from Johnson C. Smith University, in Charlotte, North Carolina, a Master of Arts in Christian Education from Pfeiffer University in Charlotte and Misenheimer, North Carolina, and a Doctor of Christian Ministry and Christian Counseling from Partners to the Promise School of Christian Education in Charlotte, North Carolina.
                        </p>
                        <p class="content text-muted">
                            Dr. Bell loves traveling and sharing Jesus with anyone who would listen. As God continues to lead Ann, she will forever lead others in their faith journey toward freedom in God. 
                        </p>
                    </div>
                </div>
            </div>
